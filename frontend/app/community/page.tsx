    ...
    <div className="pb-10">
      <div className="mx-auto max-w-4xl px-4 pt-10 sm:px-6">
        ...
        <p className="mt-2 text-black/70">
          Connect with other vendors for peer support on Discord, and with thousands of painted tree people
          on Facebook — introduce yourself in #general when you join Discord.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        {widgetId ? (
          ...
          <p className="mt-8 text-sm text-black/60">
            Set `discord_widget_id` in admin site settings to embed the widget.
          </p>
        )}
        <div className="mt-8">
          <Link
