...
- [ ] Immediate help (PRD-002): PDF downloads; triage + cash cards populated.
- [ ] Cash flow (PRD-003): ≥10 grants; state filter works.
...
- [ ] Disclaimers on crisis triage, cash flow, community pages.
